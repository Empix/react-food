...
export default function Checkout(props) {
      ...
      <form onSubmit={handleSubmit} id="checkout-form">
        ...
        <div className={styles['input-box']}>
          ...
          <input
            ...
            className={!formInputsValid.postalCode ? styles['input-error'] : ''}
          />
        </div>
  ...
  return (
    <Modal
      ...
      onConfirm={props.didSubmit ? props.onClose : null}
    >
      {props.isLoading && loadingContent}
      {props.didSubmit && didSubmitContent}
      {!props.isLoading && !props.didSubmit && checkoutContent}
    </Modal>
  );
}
